    ...
    try {
      await supabase.auth.signInWithOtp(
        ...
        emailRedirectTo: kIsWeb
            ? null
            : 'se.fantasifestivalen.fantasifestivalen://login-callback/',
      );
      if (mounted) {
