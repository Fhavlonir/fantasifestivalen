  ...
  Widget build(BuildContext context) {
    return Center(
        child: FutureBuilder<List<Rule>>(
            ...
            builder:
                (BuildContext context, AsyncSnapshot<List<Rule>> snapshot) {
              ...
              return DataTable(
                columns: const <DataColumn>[
                  DataColumn(
                    label: Expanded(child: Text('Regel')),
                  ),
                  DataColumn(
                    label: Expanded(child: Text('Poäng')),
                  ),
                  DataColumn(
                    label: Expanded(child: Text('Kategori')),
                  )
                ],
                rows: rows,
              );
